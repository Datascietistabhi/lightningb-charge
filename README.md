...
[![MIT license](https://img.shields.io/github/license/elementsproject/lightning-charge.svg)](https://github.com/ElementsProject/lightningbr-charge/blob/master/LICENSE)
...
```bash
$ npm install -g lightningb-charge
...
Requires `bitcoind`, `brocoin-cli`, `lightningd`, `lightning-cli`
